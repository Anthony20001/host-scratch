    ...
    <div class="site-menu-inner" id="ftco-navbar">
        <ul class="list-unstyled">
            <?php if (!isset($_SESSION["id_usuario"])) { ?>
                ...
                <li><a href="<?php echo "index.php?c=".seg::codificar("usuario")."&m=".seg::codificar("mostrar_usuario") ?>">Ver usuarios</a></li>
                <li><a href="<?php echo "index.php?c=".seg::codificar("suscripcion")."&m=".seg::codificar("mostrar_suscripcion") ?>">Ver Suscripciones</a></li>
