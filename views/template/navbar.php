<nav class="site-menu" id="ftco-navbar-spy">
    <div class="site-menu-inner" id="ftco-navbar">
        <ul class="list-unstyled">
            ...
            <?php } if ($_SESSION["tipo_usuario"] == 1) { ?> <!-- este es el menu de administrador -->
                <li><a href="index.php">Inicio</a></li>
            ...
            <?php } if ($_SESSION["tipo_usuario"] == 0 && !empty($_SESSION['monto_pago'])){ ?>
                ...
                <li><a href="<?php echo "index.php?c=".seg::codificar("categoria_plato")."&m=".seg::codificar("mostrar") ?>">Categorías</a></li>
