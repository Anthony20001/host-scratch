    ...
    <?php if (isset($resultado)) { ?>
      <?php foreach ($resultado as $p) { ?>
        <tr>
          ...
          <td>
            <img src="<?php echo $p['foto_plato']; ?>" style="width: 100px; height: 100px;" alt="https://upload.wikimedia.org/wikipedia/commons/thumb/6/62/NCI_Visuals_Food_Hamburger.jpg/640px-NCI_Visuals_Food_Hamburger.jpg">
          </td>
